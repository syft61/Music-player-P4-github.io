...
float sigmaskibdiddyX, sigmaskibdiddyY, sigmaskibdiddyWidth, sigmaskibdiddyHeight;
...
sigmaskibdiddyX = titleX; //Best Practice: change on formula
sigmaskibdiddyY = appHeight*4.5/10; //Ratio done last. How is this Centered Vertically?
sigmaskibdiddyWidth = titleWidth; //Best Practice
sigmaskibdiddyHeight = titleHeight; //Best Practice
...
rect( sigmaskibdiddyX, sigmaskibdiddyY, sigmaskibdiddyWidth, sigmaskibdiddyHeight ); // Testing Aspect Ratio of Fonts
...
text( phrase, sigmaskibdiddyX, sigmaskibdiddyY, sigmaskibdiddyWidth, sigmaskibdiddyHeight );
